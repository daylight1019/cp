...
import { getLeadsList, getLead, addAddress, addPhone, updateAddress, updateLeadDetail, updatePerson, updatePhone } from '../../actions/lead';
...
class EditLeadScreen extends Component {
  ...
  async initComponent() {
    ...
    console.log("Param===", JSON.stringify(this.lead))
    console.log("This Lead===", JSON.stringify(this.props.oneLeadInfo))
        ...
        <View style={styles.container}>
          <ScrollView>
            ...
            <TouchableOpacity onPress={() => this.toggleDetail()} style={{ ...styles.buttonView, backgroundColor: this.state.phoneOpen ? "rgb(236,151,31)" : "rgb(51,122,183)" }}>
              {this.state.phoneOpen ? <Icon name="minus-circle" style={{ margin: 8, height: 35 }} size={16} color="#ffffff" solid /> : <Icon name="plus-circle" style={{ margin: 8, height: 35 }} size={16} color="#ffffff" solid />}
